...
public class AlgorithmeExpensionGOL implements AlgorithmeExpension {
    ...
    public void expense(Automate automate) {
        ...
        for(int y=0; y< grille.getTaille()[1]; y++) {
            for(int x=0; x< grille.getTaille()[0]; x++){
                int position[]= {x,y};
                ...
                ArrayList<Cellule> cellulesACetEndroit = grille.getCellules(position);
